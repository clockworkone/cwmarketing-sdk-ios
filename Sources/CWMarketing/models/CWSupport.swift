...
public struct CWSupport: Codable {
    public var name: String
    public var phone: String
    public var content: String
    var os: CWCWSupportOS
    var device: CWCWSupportDevice
    var app: CWCWSupportApp
    var customerId: String?
    
    public init(name: String, phone: String, content: String) {
        var sysinfo = utsname()
        uname(&sysinfo)
...
struct CWCWSupportOS: Codable {
    var version: String
    var name: String
}

struct CWCWSupportDevice: Codable {
    var brand: String
    var model: String
}
